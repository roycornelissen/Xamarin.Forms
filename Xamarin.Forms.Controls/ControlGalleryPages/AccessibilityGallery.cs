...
namespace Xamarin.Forms.Controls
{
	...
	public static class AccessibilityExtensions
	{
		...
		{
			element.SetValue(Accessibility.AccessibilityNameProperty, name);
		}

		public static string GetAccessibilityName(this VisualElement element)
		{
			return (string)element.GetValue(Accessibility.AccessibilityNameProperty);
		}

		public static void SetAccessibilityHint(this VisualElement element, string hint)
		{
			element.SetValue(Accessibility.AccessibilityHintProperty, hint);
		}

		public static string GetAccessibilityHint(this VisualElement element)
		{
			return (string)element.GetValue(Accessibility.AccessibilityHintProperty);
		}
